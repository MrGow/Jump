...
// Burst movement
//
// Positive Y moves the top saw farther downward
...
// Playback instance
//
// The custom audio group might still be loading during
// this Create event, so End Step starts the sound later.
// ----------------------------------------------------
saw_loop_id = noone;
...
// ----------------------------------------------------
// Return the saw audio to its idle state
// ----------------------------------------------------
