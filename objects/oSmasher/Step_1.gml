...
// Keep the object fixed in the room.
x = base_x;
y = base_y;
...
plate_y_previous = plate_y_current;
...
var previous_anim_index = image_index;
...
// ----------------------------------------------------
// Measure actual plate position from current mask frame
// ----------------------------------------------------
plate_y_current = find_plate_bottom();
...
// Repeated animation frames produce zero movement.
