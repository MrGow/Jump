...
// ----------------------------------------------------
if (!variable_instance_exists(id, "checkpoint_id")) {
    checkpoint_id = "";
}
...
// Respawn location
// ----------------------------------------------------
if (!variable_instance_exists(id, "respawn_x")) {
    respawn_x = x;
}

if (!variable_instance_exists(id, "respawn_y")) {
    respawn_y = y;
}

if (!variable_instance_exists(id, "respawn_y_offset")) {
    respawn_y_offset = -30;
}
...
if (!variable_instance_exists(id, "touch_pad")) {
    touch_pad = 8;
}
